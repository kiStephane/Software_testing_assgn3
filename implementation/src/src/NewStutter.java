...
// It prints a list of repeated words, by line number.
...
class Stutter
{
 ...
 private static String dupFile = "Duplicates.txt";
//************************************************
...
private static void checkDupes (int line)
{
   ...
   if (curWord.equals(prevWord))
   {
      System.out.println ("Repeated word on line " + line + ": " +
                        prevWord+ " " + curWord);
      writeDuplicates(dupFile, line, curWord);
   }
   else
   {
      prevWord = curWord;
...
//**************************************************
// writeDuplicates() writes the duplicate Word in a
// file provided as dupFile.
//**************************************************


private static void writeDuplicates(String dupFile, int line, String Word)
{
	 try {
		// Open a file in append mode
		BufferedWriter output = new BufferedWriter(new FileWriter(dupFile, true));
		output.append("Repeated word on Line  "+ line + " : "+ Word + "\n");
		output.close();
